...
describe("contract center panel", () => {
  it("renders hero KPI, plan comparison, forecast and alerts from backend snapshot", () => {
    ...
    expect(html).toContain("Marża %");
    expect(html).toContain("Forecast kosztu fakturowego");
